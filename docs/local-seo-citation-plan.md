# Carvex local SEO citation and GBP plan

## Canonical NAP format

Use this exact public identity wherever a directory, citation, or profile allows service-area businesses without forcing a storefront address.

| Field | Value |
| --- | --- |
| Business name | Carvex |
...
Prioritize profiles that support Hungarian businesses and service-area wording.

| Target | Action |
| --- | --- |
| Google Business Profile | Create or update service-area profile. |
| Facebook | Verify Carvex page website, phone, email, and service area. |
...
- After a completed inspection, ask for an honest review without incentives or review gating.
